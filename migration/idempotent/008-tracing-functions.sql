...
-- Note: This function is getting depracted. New versions of connector will use _prom_catalog.create_ingest_temp_table.
...
IS 'Note: This function is getting depracted. New versions of connector will use _prom_catalog.create_ingest_temp_table.
Creates a temporary table (if it doesn''t exist), suitable for tracing data ingestion. 
Supresses corresponding DDL logging, otherwise PG log may get unnecessarily verbose.';
